      ...
      <article className="pt-24 pb-16">
        ...
        <header className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
          ...
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-4">
            ...
            <span>/</span>
            <Link href={`/${article.category.toLowerCase().replace(/\s+/g, '-')}`} className="hover:text-cyber-cyan transition-colors">
              {article.category}
            </Link>
            <span>/</span>
          ...
          {/* Description */}
          <p className="text-lg text-gray-400 mb-6">{article.description}</p>

          {/* Author & Share */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-cyber-gray/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-3 max-w-4xl">
              ...
              {/* Comment Placeholder */}
              <div className="mt-12 p-8 cyber-card text-center">
    ...
    <section className="py-12 border-t border-cyber-gray/30">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {prev && (
            <Link href={`/article/${prev.slug}`} className="cyber-card group text-left">
          ...
          {next && (
            <Link href={`/article/${next.slug}`} className="cyber-card group text-right">
